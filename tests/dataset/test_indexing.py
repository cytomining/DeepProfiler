...
def test_write_compression_index():
    temp = os.path.dirname("/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/")
    if os.path.exists(temp) == False:
        os.makedirs(temp)
    open_file = open("/Users/msmith/DeepProfiler/deepprofiler/examples/config/data.json")
    config = json.load(open_file)
    deepprofiler.dataset.indexing.write_compression_index(config)
    test_output = pd.DataFrame.from_csv("/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index.csv")
...
def test_split_index():
    ...
    config = json.load(open_file)
    test_parts = 3
    test_paths = ["/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-000.csv",
                  "/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-001.csv",
                  "/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-002.csv"]
    deepprofiler.dataset.indexing.write_compression_index(config)
    ...
    test_outputs = [pd.DataFrame.from_csv("/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-000.csv"),
                    pd.DataFrame.from_csv("/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-001.csv"),
                    pd.DataFrame.from_csv("/Users/msmith/DeepProfiler/deepprofiler/examples/metadata/tmp/index-002.csv")]
